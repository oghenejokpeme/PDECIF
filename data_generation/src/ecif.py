...
def get_molecule_features(protein, ligand, distance = 6):
    molecule_features = {}
...
def write_dataset(subset, molecule_ids, all_features, all_molecule_features, protonate):
    ...
    filepath = ''
    if protonate:
        filepath = '../output/x_ecif_with_hs_' + subset.lower() + '.csv'
    else:
        filepath = '../output/x_ecif_without_hs_' + subset.lower() + '.csv'
